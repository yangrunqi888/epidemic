<template>
    <div v-loading="loading">
         ...
         <el-dialog title="新增" :visible.sync="insertDialogVisible" width="50%" :before-close="handleClose">
            <el-form ref="insertStaff" :model="insertForm" :rules="rules" label-width="150px">
                <el-row :gutter="20">
                    <el-col :span="12">
                        <el-form-item label="工号" prop="employeeNumber">
                            <el-input v-model="insertForm.employeeNumber" placeholder="请输入工号"></el-input>
                        </el-form-item>
                    ...
                    <el-col :span="12">
                        <el-form-item label="姓名" prop="name">
                            <el-input v-model="insertForm.name" placeholder="请输入管理人员姓名"></el-input>
                        </el-form-item>
                        ...
                        <el-form-item prop="employmentStart" label="入职时间">
                            <el-date-picker type="date" placeholder="请选择入职时间" v-model="insertForm.employmentStart"
                                style="width: 100%;" format="yyyy-MM-dd" value-format="yyyy-MM-dd"></el-date-picker>
                        </el-form-item>
            ...
            <span slot="footer">
                            <el-button type="primary" @click="submitForm('insertStaff')">确定</el-button>
                            <el-button @click="resetForm('insertStaff')">重置</el-button>
                        </span>
        </el-dialog>
         <!-- 编辑对话框 -->
         <el-dialog title="修改" :visible.sync="editDialogVisible" width="50%" :before-close="handleClose">
            <el-form ref="editStaff" :model="editForm" :rules="rules" label-width="150px">
                <el-row :gutter="20">
                    <el-col :span="12">
                        <el-form-item  label="工号" prop="employeeNumber">
                            <el-input disabled v-model="editForm.employeeNumber" placeholder="请输入工号"></el-input>
                        </el-form-item>
                        <el-form-item label="身份证号" prop="idNumber">
                    ...
                    <el-col :span="12">
                        <el-form-item label="姓名" prop="name">
                            <el-input v-model="editForm.name" placeholder="请输入管理人员姓名"></el-input>
                        </el-form-item>
                        <el-form-item prop="education" label="学历">
                        ...
                        <el-form-item prop="employmentStart" label="入职时间">
                            <el-date-picker type="date" placeholder="请选择入职时间" v-model="editForm.employmentStart"
                                style="width: 100%;" format="yyyy-MM-dd" value-format="yyyy-MM-dd"></el-date-picker>
                        </el-form-item>
                        <el-form-item label="电子邮箱" prop="email">
            ...
            <span slot="footer">
                            <el-button type="primary" @click="editStaff('editStaff')">确定</el-button>
                        </span>
        </el-dialog>
        <!-- 筛选对话框 -->
        <el-dialog title="筛选" :visible.sync="filterDialogVisible" width="50%" :before-close="handleFilterClose">
            <el-form ref="filterForm" :model="searchInformation">
                <el-row :gutter="20">
                    <el-col :span="12">
                        <el-form-item label="工号" prop="employeeNumber">
                            <el-input v-model="searchInformation.employeeNumber" placeholder="请输入管理人员工号"
                                style="width:80%"></el-input>
                        </el-form-item>
                        <el-form-item label="身份证号" prop="idNumber">
                            <el-input v-model="searchInformation.idNumber" placeholder="请输入管理人员身份证号"
                                style="width:80%"></el-input>
                    ...
                    <el-col :span="12">
                        <el-form-item label="姓名" prop="name">
                            <el-input v-model="searchInformation.name" placeholder="请输入管理人员姓名"  style="width:80%"></el-input>
                        </el-form-item>
                        <el-form-item prop="politicsStatus" label="政治面貌">
                            <el-select v-model="searchInformation.politicsStatus" filterable multiple
                                placeholder="请选择政治面貌">
                                <el-option v-for="item in  politicsStatusOptions" :key="item" :label="item" :value="item">
                                </el-option>
                            </el-select>
                        ...
                        <el-form-item prop="position" label="职位">
                            <el-select v-model="searchInformation.position" filterable multiple
                                placeholder="请选择职位">
                                <el-option v-for="item in  positionOptions" :key="item.value" :label="item.label" :value="item.value">
                                </el-option>
                            </el-select>
                        </el-form-item>
                        <el-form-item label="入职日期范围" prop="employmentStart">
                    <el-date-picker type="daterange" placeholder="选择日期范围" v-model="searchInformation.employmentStart"
        ...
        <!-- 新增居民按钮 -->
        <div class="insert">
            <el-button type="primary" @click="insertDialogVisible = true">新增管理人员</el-button>
        </div>
        <div class="filter">
            ...
            <template slot="footer" >
                <el-button type="primary" @click="handleEditForm()">编辑</el-button>
                        ...
                        <el-popconfirm confirm-button-text='是' cancel-button-text='否' icon="el-icon-info"
                            icon-color="orange" :title="`是否要重置工号${this.detailInformation.employeeNumber}的员工密码`"
                            @confirm="resetStaff()">
                        ...
                        <el-popconfirm confirm-button-text='是' cancel-button-text='否' icon="el-icon-info" icon-color="red"
                            :title="`是否要删除工号${this.detailInformation.employeeNumber}的员工信息`" @confirm="deleteStaff()">
...
<script>
import { getData, insertData, deleteData, resetPassword, editData } from "@/api/staff"
export default {
    data() {
        return {
            loading:false,
            ...
            tableColmuns: [{ "label": "工号", "prop": "employeeNumber" }, { "label": "身份证号", "prop": "idNumber" }, { "label": "姓名", "prop": "name" }, { "label": "性别", "prop": "gender" }, { "label": "年龄", "prop": "age" }, { "label": "出生日期", "prop": "birthday" }
                ,  { "label": "入职时间", "prop": "employmentStart" }],
                dialogColumns: [{ "label": "工号", "prop": "employeeNumber" }, { "label": "身份证号", "prop": "idNumber" }, { "label": "姓名", "prop": "name" }, { "label": "性别", "prop": "gender" }, { "label": "年龄", "prop": "age" }, { "label": "出生日期", "prop": "birthday" }
            ...
            positionOptions:[{label:"网格员",value:"1"},{label:"网格长",value:"2"},{label:"片长",value:"3"},],
                tableData: [],
            pagination: {
                //分页相关属性
                currentPage: 1,
    ...
    methods: {
        ...
        deleteStaff() {
            deleteData(this.detailInformation.employeeNumber).then((res) => {
                if (res.data.code == 200) {
        ...
        resetStaff() {
            resetPassword(this.detailInformation.employeeNumber).then((res) => {
                if (res.data.code == 200) {
                    this.detailDialogVisable=false;
